    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="situcacio" class="form-control" id="situcacio" readonly
                       placeholder="Situació del producte" required value="<?php
                       if (isset($ubicacio)) {
                           echo $ubicacio->getSituacio();
                       }
                       ?>">
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                ?>
                <input type="radio" id="conservar" name="conservar" value="0" disabled readonly <?php
                if ($fred == 1) {
                    echo "checked";
                }
                ?>> Si<br>
                <input type="radio" id="conservar" name="conservar" value="1" disabled readonly <?php
                if ($fred != 1) {
                    echo "checked";
                }
                ?>>No<br>
            ...
            <div class="form-group" id="capacitatMl" hidden>
                ...
                <input type="text" name="capacitatMlInput" class="form-control" readonly
                       placeholder="Capacitat en Ml" required value="<?php
            ...
            <div class="form-group" id="capacitatMg" >
                ...
                <input type="text" name="capacitatMgInput" class="form-control" readonly
                       placeholder="Capacitat en Mg" required value="<?php
            ...
            <div class="form-group" id="unitats">
                ...
                <input type="text" name="unitatsInput" class="form-control" readonly
                       placeholder="Número d'unitats" required value="<?php
            ...
            <div class="form-group">
                ...
                <input type="text" name="quantitatTenda" class="form-control" id="quantitatTenda" readonly
                       placeholder="Quantitat en tenda" required value="<?php
                       if (isset($ubicacio)) {
                           echo $ubicacio->getQuantitatTenda();
                       }
                       ?>">
            </div>
            <div class="form-group">
                ...
                <input type="text" name="quantitatMagatzem" class="form-control" id="quantitatMagatzem" readonly
                       placeholder="Quantitat en magatzem" required value="<?php
                       if (isset($ubicacio)) {
                           echo $ubicacio->getQuantitatStock();
                       }
                       ?>">
            </div>
        </div>
