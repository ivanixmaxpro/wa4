...
--
-- Host: localhost
-- Generation Time: Apr 26, 2017 at 05:20 
...
(1, 1, 'Ivan', 'Mir', '000000', 'asddasasdwqwfd3yyu54h', 1, 111111111, 'uuuu', 'adsasdadsaasdda'),
(2, 1, 'dsad', 'dad', '434', 'addsad', 11, 11, NULL, NULL);
...
--
ALTER TABLE `empleat`
  MODIFY `id_empleat` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `usuari`
  MODIFY `id_usuari` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
